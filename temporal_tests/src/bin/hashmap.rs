    ...
    while !done {
        ...
        match choice {
            1 => {
                ...
                // Create object outside of RC stuff with raw pointer and see how compiler reacts. UNSAFE
                ...
                // Issue might be that since i wrap raw pointer in rc and not the actual object, the object is going out of scope, while the rp is being preserved. 
            },
            2 => {
